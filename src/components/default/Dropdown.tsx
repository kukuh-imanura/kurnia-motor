...
export default function Dropdown() {
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button className={`w-40 text-center inline-flex w-full justify-center gap-x-1.5 px-3 py-2 hover:font-bold hover:text-brand-1 ${useLocation().pathname === "/customer" || useLocation().pathname === "/admin" || useLocation().pathname === "/laporan" ? 'font-bold text-brand-1' : ''}`}>Layanan</Menu.Button>
      </div>
